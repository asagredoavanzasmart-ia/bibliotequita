...
export function AddManualModal({ onClose, onAdd, demoQuota }: AddManualModalProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[9999]">
      <div className="bg-[var(--bg-app)] rounded-2xl shadow-xl w-full max-w-3xl lg:max-w-[62rem] overflow-hidden animate-in fade-in zoom-in-95 flex flex-col h-[95dvh] max-h-[95dvh] md:h-auto md:max-h-[85vh] [@media(max-height:500px)_and_(orientation:landscape)]:h-[92dvh] [@media(max-height:500px)_and_(orientation:landscape)]:max-h-[92dvh]">
        ...
        <form id="add-manual-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto md:overflow-hidden [@media(max-height:500px)_and_(orientation:landscape)]:overflow-y-auto p-3 md:p-5">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 [@media(max-height:500px)_and_(orientation:landscape)]:grid-cols-3 gap-4 md:gap-6 [@media(max-height:500px)_and_(orientation:landscape)]:gap-3 min-h-min md:h-full md:items-start [@media(max-height:500px)_and_(orientation:landscape)]:items-start">
              <div className="md:col-span-1 [@media(max-height:500px)_and_(orientation:landscape)]:col-span-1 flex flex-col gap-2 items-center md:sticky md:top-0 [@media(max-height:500px)_and_(orientation:landscape)]:sticky [@media(max-height:500px)_and_(orientation:landscape)]:top-0">
